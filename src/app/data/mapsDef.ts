...
export const Map16Tokens: Token[] = [
  ...
  {id: 'Earth-Demon', name: 'Earth-Demon', type: 'enemy', src: 'assets/Earth-Demon_token.jpg', maxHealth: 7, health: 7, shield: 1, move: 1, attack: 2, range: 3, status: {} },
  {id: 'Earth-Demon_elite', name: 'Earth-Demon', type: 'enemy elite', src: 'assets/Earth-Demon_token.jpg', maxHealth: 11, health: 11, shield: 1, move: 1, attack: 3, range: 3, status: {} },
  {id: 'Wind-Demon', name: 'Wind-Demon', type: 'enemy', src: 'assets/Wind-Demon_token.jpg', maxHealth: 4, health: 4, move: 3, attack: 1 },
  {id: 'Wind-Demon_elite', name: 'Wind-Demon', type: 'enemy elite', src: 'assets/Wind-Demon_token.jpg', maxHealth: 7, health: 7, move: 3, attack: 2 },
