...
@Component({
  selector: 'app-scenario-fixed',
  templateUrl: './scenario-fixed.component.html',
  styleUrls: ['./scenario-fixed.component.css']
})
export class ScenarioFixedComponent implements OnInit {
