...
@Component({
  selector: 'app-scenario-responsive',
  templateUrl: './scenario-responsive.component.html',
  styleUrls: ['./scenario-responsive.component.css']
})
export class ScenarioResponsiveComponent implements OnInit {
